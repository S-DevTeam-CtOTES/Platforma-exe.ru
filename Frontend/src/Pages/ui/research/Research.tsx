    ...
    <section className="Research__component">
      ...
      <div className="Research__component-container container">
        <div className="Research__component-leftPart">
          ...
          <p className="Research__component-leftPart-subtitle">
            Эта страница находиться в разработке!<br></br>Чтобы быть в курсе
            всех последний новостей,<br></br> приглашаем вас следить за нами в
            социальных сетях
          </p>
          <div className="Research__component-leftPart-links">
            <a href="https://t.me/platformaexe">
              <img src={Telegram}></img>
            </a>
            <a href="https://vk.com/platformaexe">
              <img src={VK}></img>
            </a>
            <a href="https://www.youtube.com/@platforma-exe">
              <img src={Youtube}></img>
            </a>
          </div>
        </div>
